...
readingMinutes: 2
tags: ["design-ed","people"]
---

> Why go to all that trouble, to do all this? \[Talking about typographic niceties; dashes, quotes and the like.\] Aesthetics… is not such a compelling argument for this. Or for anything. Because it is highly subjective. Furthermore, it is a function of time and space. At a larger level. What we, Indians consider to be beautiful, Americans might not consider to be beautiful. Aesthetics is also very infectious. In some senses, you can be _trained_ to like certain things. If I faff a lot about this font \[points to a screen showing various kinds of quote marks, dashes and an ellipsis _and_ their HTML character codes\], you will suddenly start liking it. Because I faffed about it. … These are the kind of questions we dabble in… \[in\] academics. … Ha… _matlab_, for whatever reasons.

— Girish Dalvi, [Practical Web typography (1) on D’Source](http://www.dsource.in/course/digital-typography-1/video/practical-web-typography-part-i-girish-dalvi)

I had the browser open to [Girish’s homepage](http://www.idc.iitb.ac.in/~girish/) on the quirky and sane IDC website and one hyperlink lead to another and in no-time (in real time, though, it was thirty seven seconds into the first video), I was grinning at that lecture-series (in four parts). Outside of the video, he dabbles in teaching typography, books, sharing obscure and critical information — processed, and presented with deliberate commentary after being asked six times, being nice to people, commenting on excel-sheet course plans and helping young kids (…) testing teaching-waters, etc., when not putting together an impressive (intimidating) number of multilingual fonts with folks at EkType.
