...
\[1\]: Distraction-free implementation takes a while to get right. The right balance between focus and isolation is tricky at best. I see why iA is expensive. Safe to assume [Ananthu](https://www.stet.in/) has been a power user of Zettlr for a while, so I’m going to talk to him about this.
...
\[3\]: There is a link to some of the material at [exif/teaching](/blog/teaching) Justincase. ‘Infinite-Gestalt’ is what we had (unanimously in the way dictatorships are run) christened a Typography2 course in 2022.

\[4\]: Girish introduced us to the book. Short, to-the-point, fresh.

**Links**

While binge-skipping through _Lincoln Lawyer_ behind an unmanageable large Figma file, came across [this beautiful Mattiel Song](https://www.youtube.com/watch?v=CgeY8K_ohlc). [Forest](https://theforest.link/) has been good company. Such beauty everywhere on the internet. Here is ‘ [Introducing the Concept of Radical User Friendliness in Web Design.](https://cheapskatesguide.org/articles/radical-user-friendliness.html)’
